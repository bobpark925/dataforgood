# NPO 국제컨퍼런스_변화의 기술 : 데이터스토리텔러되기 페이지입니다.
...
3. 시간표(예정) 2019. 9. 2. 오후 2시 30분 ~ 4시 30분
...
(2) 워크숍
가. 빅데이터-스몰데이터 모둠
: 파이썬(Python)을 이용한 (빅)데이터 분석의 가능성을 체험해보고, 해당 데이터에 각자 경험한 지식(이른바 도메인지식)을 더해 설득력 있는 데이터스토리(가설-검증)를 만들어보는 모둠
많은 시민들이 이용하고 있는 공공자전거 따릉이 데이터와 청와대 국민청원 데이터를 사용하여 나만의 데이터스토리를 만들어봄
